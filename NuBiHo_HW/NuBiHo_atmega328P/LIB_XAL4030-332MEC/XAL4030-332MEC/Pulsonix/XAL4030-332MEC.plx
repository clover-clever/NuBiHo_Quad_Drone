...
//292587/1302239/2.50/2/4/Inductor
...
(library Library_1
	...
	(patternDef "XAL40XX" (originalName "XAL40XX")
		(multiLayer
	...
	(symbolDef "XAL4030-332MEC" (originalName "XAL4030-332MEC")
	...
	(compDef "XAL4030-332MEC" (originalName "XAL4030-332MEC") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "XAL4030-332MEC"))
		(attachedPattern (patternNum 1) (patternName "XAL40XX")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "994-XAL4030-332MEC")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Coilcraft/XAL4030-332MEC?qs=zCSbvcPd3paCl%252Bgj18yZeg%3D%3D")
		(attr "Manufacturer_Name" "COILCRAFT")
		(attr "Manufacturer_Part_Number" "XAL4030-332MEC")
		(attr "Description" "COILCRAFT - XAL4030-332MEC - INDUCTOR, 3.3UH, 6.6A, 20%, PWR, 43MHZ")
		(attr "<Hyperlink>" "https://www.coilcraft.com/pdfs/xal4000.pdf")
		(attr "<STEP Filename>" "XAL4030-332MEC.stp")
